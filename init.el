...
(use-package bufferlo
  ...
  ;; The same for new frames.
  (add-hook 'after-make-frame-functions #'bufferlo-switch-to-local-scratch-buffer)
  ;; By default, use bufferlo's local buffer list.
  (bufferlo-anywhere-mode t)
  ;; Consult integration. Show local buffers first, then all others.
